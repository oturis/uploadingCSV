class FacultiesController < ApplicationController
  ...
  def index
    ...
    respond_to do |format|
      format.html
      format.csv {send_data @faculties.to_csv('first_name', 'last_name', 'title', 'office_number', 'email_address', 'phone_number') }
    end
  end
  ...
  def import
    ...
    redirect_to faculties_path, notice: "Faculty Added"
  end
  ...
  private
    ...
    def faculty_params
      params.require(:faculty).permit(:last_name, :first_name, :title, :office_number, :email_address, :phone_number)
    end
end
